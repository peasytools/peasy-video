"""peasy-video API client — Access Peasy Video tools via REST API.

Usage::

    from peasy_video.api import PeasyVideoAPI

    api = PeasyVideoAPI()
    tools = api.list_tools()          # paginated: {"count", "next", "results": [...]}
    tool = api.get_tool("video-compress")
"""
...
class PeasyVideoAPI:
    ...
    def __init__(self, base_url: str = "https://peasyvideo.com") -> None:
